...
srun python -m torch.distributed.run --nproc_per_node=1 --master_addr=127.0.0.1 --master_port=29500 main_finetune.py --batch_size 32 --model metaspikformer_8_512 --data_path flowers102_imagenet_like/ --eval --resume checkpoint-2243.pth --output_dir outputs/trash
